    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while(option != "e")
            {
                ...
                Console.WriteLine("Enterv e to exit the program.");
                ...
                else if (option == "2")
                {
                    ...
                    Console.WriteLine("Please enter the number of the tasks to remove from the list.");
            ...
            Console.WriteLine("Thank you for using the program!1");
        }
    }
}
